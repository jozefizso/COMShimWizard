...
namespace TestSmartTagRecognizerAction
{
	...
	[ProgId("TestSmartTagRecognizerAction.SomeRecognizerProgId")]
	public class Recognizer : SmartTagLib.ISmartTagRecognizer
	{
		...
		public string ProgId
		{
			get 
			{
				...
				return "TestSmartTagRecognizerAction.Recognizer";
			}
		}
		...
		{
			return "TestSmartTagRecognizerAction recognizes company names";
		}
