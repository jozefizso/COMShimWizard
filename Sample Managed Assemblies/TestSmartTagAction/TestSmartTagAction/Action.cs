...
namespace TestSmartTagAction
{

	[GuidAttribute("D47D6BAA-3989-46e8-ADCA-250DDE710DF2")]
	[ProgId("TestSmartTagAction.SomeProgId")]
	public class Action: SmartTagLib.ISmartTagAction
	{
		...
		public string ProgId
		{
			get 
			{
				return "TestSmartTagAction.Action";
			}
		}
		...
		{
			return "Provides actions for the TestSmartTagAction SmartTag";
		}

		public string get_Name(int LocaleID)
		{
			return "TestSmartTagAction Smart Tag";
		}
		...
		public string get_SmartTagName(int SmartTagID)
		{
			...
			// for the smart tag.
			return "Contoso/TestSmartTagAction#Symbols";
		}
		...
		public int get_VerbCount(string SmartTagName)
		{
			...
			if (SmartTagName.Equals("Contoso/TestSmartTagAction#Symbols")) 
			{
				return 1;
			}
			return 0;
